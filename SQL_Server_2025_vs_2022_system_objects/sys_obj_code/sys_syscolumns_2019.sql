...
CREATE VIEW sys.syscolumns_2019 AS
	...
	LEFT JOIN sys.sysobjvalues sov8 ON sov8.valclass = 183 /*SVC_COLUMN_VECTOR_PROPERTY*/ and sov8.objid = c.id and sov8.subobjid = c.colid and sov8.valnum = 0 -- VALNUM_VECTOR_PROPERTY_DIM_NUM
	LEFT JOIN sys.sysobjvalues sov9 ON sov9.valclass = 183 /*SVC_COLUMN_VECTOR_PROPERTY*/ and sov9.objid = c.id and sov9.subobjid = c.colid and sov9.valnum = 1 -- VALNUM_VECTOR_PROPERTY_BASE_TYPE
