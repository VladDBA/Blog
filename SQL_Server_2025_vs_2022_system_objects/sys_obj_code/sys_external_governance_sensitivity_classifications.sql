...
CREATE VIEW sys.external_governance_sensitivity_classifications AS
	SELECT
		...
		END AS rank_desc
	FROM sys.columns c
	LEFT JOIN sys.sysobjvalues sov1 ON c.object_id = sov1.objid AND c.column_id = sov1.subobjid and sov1.valclass = 170
	LEFT JOIN sys.sysobjvalues sov2 ON c.object_id = sov2.objid AND c.column_id = sov2.subobjid and sov2.valclass = 171
	LEFT JOIN sys.sysobjvalues sov3 ON c.object_id = sov3.objid AND c.column_id = sov3.subobjid and sov3.valclass = 172
	LEFT JOIN sys.sysobjvalues sov4 ON c.object_id = sov4.objid AND c.column_id = sov4.subobjid and sov4.valclass = 173
